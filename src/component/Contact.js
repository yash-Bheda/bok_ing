...
<Navbar/>
            ...
            <div className='text-center text-white fs-2 abouttext '>
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3639.9552631744855!2d72.41365453722237!3d24.17330167847414!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395cebdd722cf687%3A0xf75bc4a3b39a51f3!2sHotel%20Way%20Wait%20-%20Best%20Hotel%2C%20Ac%20Hotel%2C%20Budget%20Hotels!5e0!3m2!1sen!2sin!4v1704086059248!5m2!1sen!2sin"style={{ width:"100%", height:"500px" ,style:"border:0;"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
               ...
               <div className='contactinfo container '>
                ...
                <div className='msginfo '>
                    <div className='m-2' >
                    <input placeholder='Enter Your Name' style={{height:"50px", width:"100%"}}></input>

                    </div>
                    <div className='m-2'>
                    <input placeholder='Enter Your Mail' style={{height:"50px", width:"100%"}}></input>
                    ...
                    <div className='m-2'>
                        <textarea  rows={5}placeholder='Enter Your Message'style={{height:"50px", width:"100%"}}>
